...
export default function Weblogs() {
  ...
  return (
    <div className="pt-12 md:pt-24 max-w-4xl mx-auto">
      {/* Header */}
      <section className="mb-20 border-b border-[#D3D9D4] pb-8">
        <h1 className="font-serif text-5xl md:text-7xl text-[#2D2D2D] mb-6">Archive</h1>
          ...
          >
            ...
            >
              <div className="flex items-baseline gap-8">
                ...
                <h2 className="font-serif text-2xl text-[#2D2D2D] group-hover:text-[#C65D3B] transition-colors">
                  {post.title}
                </h2>
              </div>
